...
description: "Use keywords and conditions to narrow the scope of the search when searching for data when using the Data Investigation in Microsoft 365."
---
